...
from ..erosions.hydraulic_erosion_particle_based import hydraulic_erosion_pb, HydraulicErosionPBSettings
...
class ErosionOperator(bpy.types.Operator):
    ...
    def main(self, context: bpy.types.Context):
        ...
        if properties.erosion_method == "THERMAL":
            ...
            thermal_erosion(context, settings)
        ...
        # Hydraulic erosion - particle based
            ...
            hydraulic_erosion_pb(context, settings)
